...
$website = "Eden Dubiso's BIG Page";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
?>
	...
	<div>	
		<fieldset>
			...
			<input type="checkbox" name="Interested_In[]" value="New Website" tabindex="40" /> House Cleaning <br />
			<input type="checkbox" name="Interested_In[]" value="Website Redesign" /> Company Cleaning <br />
			<input type="checkbox" name="Interested_In[]" value="Special Application" /> Moving Out Cleaning <br />
			<input type="checkbox" name="Interested_In[]" value="Lollipops" /> Moving In cleaning <br />
